        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-neutral-900 space-y-8 animate-fade-in">
            ...
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-white/80 dark:text-white/70">
                  Assam Health Initiative
                </p>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight dark:text-white">
              Screening <span className="text-red-600">Endemic Diseases</span>
              <br />
              Without Lab Tests
            </h1>
            ...
            <div className="grid grid-cols-3 gap-4 py-4 dark:text-white">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-neutral-900 mt-1 dark:text-white">
                  Women Anemic
                  <br />
                  in Assam
                </div>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 text-sm text-neutral-900 dark:text-white">
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-neutral-900 dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
          ...
          <div className="relative animate-slide-up hidden lg:block">
            <div className="relative">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 mb-4">
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        {[0, 1, 2, 3, 4, 5, 6, 7].map((num) => (
                          <button
                            key={num}
                            className="py-3 px-4 rounded-lg font-semibold bg-gray-100 text-gray-700 hover:bg-primary-600 hover:text-white transition-colors"
                          >
                            {num}
                          </button>
                        ))}
              ...
              <div
                className="absolute -right-16 bottom-32 bg-white rounded-xl shadow-xl p-4 w-48 animate-float"
